...
$string['regeneratepassword'] = 'إعادة توليد كلمة مرور خروج جديدة (عشوائية)';
$string['alloweddomains'] = 'النطاقات والروابط المسموح بزيارتها (القائمة البيضاء)';
$string['alloweddomains_help'] = 'أدخل أي نطاقات أو روابط خارجية إضافية يُسمح للطالب بالدخول إليها أثناء الامتحان (نطاق واحد في كل سطر، مثل: backup-lms.sanad.ws أو cdn.sanad.ws). سيقوم متصفح Sanad الآمن بالسماح بالاتصال بهذه العناوين وحظر ما سواها.';
